  ...
  return (
    <main className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-2">🔥 Food & Beverage Menu</h1>
        <p className="text-gray-600 mb-8">Explore delicious dishes from our partner restaurants.</p>
        ...
        {fetchedDishes.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {fetchedDishes.map((dish) => (
              <div key={dish.id} className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100 p-5 flex flex-col justify-between hover:shadow-lg transition-shadow">
                <div>
                  ...
                  <h2 className="text-xl font-bold text-gray-900 mt-3">{dish.name}</h2>
